...
export default function Register() {
  ...
  const handlePhoneChange = (value: string) => {
    ...
    const phoneError =
      digitsOnly.length < 10 ? "Please enter a valid phone number" : null;
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                {errors.firstName && (
                  <p className="text-red-500 text-xs" id="firstName-error">
                    {errors.firstName}
                  </p>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                {errors.lastName && (
                  <p className="text-red-500 text-xs" id="lastName-error">
                    {errors.lastName}
                  </p>
                )}
              </div>
            ...
            <div className="space-y-2">
              ...
              {errors.password && (
                <p className="text-red-500 text-xs" id="password-error">
                  {errors.password}
                </p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              {errors.confirmPassword && (
                <p className="text-red-500 text-xs" id="confirmPassword-error">
                  {errors.confirmPassword}
                </p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              />
              {errors.phone && (
                <p className="text-red-500 text-xs" id="phone-error">
                  {errors.phone}
                </p>
              )}
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                ...
                >
                  ...
                  <Link
                    href="/terms"
                    className="text-[#AD0000] hover:text-red-600 font-medium"
                  >
              ...
              {errors.termsAccepted && (
                <p className="text-red-500 text-xs" id="terms-error">
                  {errors.termsAccepted}
                </p>
              )}
              ...
              {errors.privacyAccepted && (
                <p className="text-red-500 text-xs" id="privacy-error">
                  {errors.privacyAccepted}
                </p>
              )}
            </div>
