...
import { ChartNoAxesGantt, CreditCard, FileText, Heart, Mail, Search, Settings, User } from 'lucide-react';
...
export default function DashboardPage() {
  ...
  const navItems = [
    { id: 'profile', label: 'Profile', icon: userData.avatar || <User className="w-5 h-5" /> },
    { id: 'overview', label: 'Overview', icon: <ChartNoAxesGantt className="w-5 h-5" /> },
